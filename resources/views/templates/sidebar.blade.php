        ...
        <ul class="sidebar-menu">
            @if (Auth::user()->role_user == 1)
                ...
                <li class="{{ request()->is('dashboard-admin*') ? 'active' : '' }}"><a class="nav-link"
                        href="{{ route('dashboard.admin') }}"><i class="fas fa-fire"></i>
