                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="{{ asset('/gambar/logo.jpeg') }}" alt="logo" width="100"
                                class="shadow-light">
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('login') }}" class="needs-validation"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="username" type="test" class="form-control" name="username"
                        ...
                        {{-- <div class="mt-5 text-muted text-center">
                            Don't have an account? <a href="{{ route('regist') }}">Create One</a>
                        </div>
