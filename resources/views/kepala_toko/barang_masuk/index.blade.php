...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('hapus.barang.masuk', $item->id) }}" method="post">
                                            @method('DELETE')
                                            @csrf
                                            <a href="#" data-target="#editBarangMasuk{{ $item->id }}"
    ...
    <!-- Modal Ubah-->
    @foreach ($masuks as $item)
        <div class="modal fade" id="editBarangMasuk{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('ubah.barang.masuk', $item->id) }}" method="post"
