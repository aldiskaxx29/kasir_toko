     ...
     <div class="text-center border-bottom">
      ...
      <table class="table text-right">
        <tr>
          ...
          <td style="width: 100px;">Rp. {{ number_format($transaksi->total_harga,0,',','.') }}</td>
        </tr>
        <tr>
          <th colspan="2">Pembayaran</th>
          <td style="width: 100px;">Rp. {{ number_format($transaksi->pembayaran,0,',','.') }}</td>
        </tr>
        <tr>
          <th colspan="2">Kembalian</th>
          <td style="width: 120px;">Rp. {{ number_format($transaksi->kembalian,0,',','.') }}</td>
        </tr>
      </table>
