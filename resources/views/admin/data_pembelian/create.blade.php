                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{-- <select name="barangs_id[]" class="form-control barangs_id" id="select-typahead"
                                        onchange="changeBarang(0);">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control qty0" onchange="calculateHarga(0);"
                                        onkeyup="calculateHarga(0);" placeholder="Jumlah" name="quantity[]">
                                    @error('quantity')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="harga[]" class="form-control harga_satuan"
                                        id="harga_satuan0" readonly>
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                                    <br>
                                    <button id="new-form" type="button"
                                        class="btn btn-success btn-sm mb-2 form-control mt-2"><i
        ...
        $("#new-form").click(function() {
            ...
            html +=
              ...
              <div class="col-md-3">
                <div class="form-group">
                    <label for="">Nama Barang</label>
                    <select name="barangs_id[]" class="form-control barangs_id select-typahead" onchange="changeBarang(` +
                i + `);">
                        <option value="">-- Pilihan --</option>
                        @foreach ($barang as $item)
                            <option class="text-capitalize" value="{{ $item->id }}" data-barang="{{ $item }}">{{ $item->nama_barang }}</option>
                            @endforeach
                        </select>
                    @error('barangs_id')
                        <small class="text-danger">{{ $message }}</small>
              ...
              <div class="col-md-2">
                <div class="form-group">
                    <label for="">Quantity</label>
                    <input type="number" class="form-control qty` + i + `" onchange="calculateHarga(` + i +
                `);" onkeyup="calculateHarga(` + i + `);" placeholder="Jumlah" name="quantity[]">
                    @error('quantity')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
